...
window.TipManager =
{
	...
	render: function()
	{
		...
		if(arrowPosition == "down")
		{
			...
			arrowBounds.moveRelative("bottom", this.elementBounds, "top", 0, 0);
			
			arrowBounds.moveBy(offset, 0);
			
			var extentBounds = new Bounds(this.tipBounds.bottom, this.tipBounds.right - 5, this.tipBounds.bottom + this.arrowElement.getHeight(), this.tipBounds.left + 5);
		...
		else
		{
			...
			arrowBounds.moveRelative("top", this.elementBounds, "bottom", 0, 0);
			
			arrowBounds.moveBy(offset, 0);
			
			var extentBounds = new Bounds(this.tipBounds.top - this.arrowElement.getHeight(), this.tipBounds.right - 5, this.tipBounds.top, this.tipBounds.left + 5);
...
window.Help =
{
	...
	open: function(inSlug)
	{
		...
		var params = $H({lang: this.options.lang});
